...
- Drow  some of the classes in the class diagram and their relationships
- Drow the process of Marketer Actor in a use-case diagram 
- Fix the class diagram and usecase diagram at the end of the project
- Create the README (Markfile) of the project
