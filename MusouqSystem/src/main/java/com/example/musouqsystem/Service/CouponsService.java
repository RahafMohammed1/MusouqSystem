...
public class CouponsService {
    ...
    public Set<Coupons> MarketerViewHisCoupons(Integer marketer_id) {
        ...
        if (marketer.getCoupons().isEmpty() ) throw new ApiException("you have not any coupon yet");
    ...
    public void marketerUpdateCoupon(Integer marketer_id, Integer coupon_id, Coupons coupons) {
        ...
        if(coupons1==null)throw new ApiException("coupon not found");
        if (coupons1.getMarketer().getId() != marketer_id) throw new ApiException("the coupon not belong to you");
    ...
    public void marketerDeleteCoupon(Integer marketer_id, Integer coupon_id) {
        ...
        if(coupons==null)throw new ApiException("coupon not found");
    ...
    public void marketerActivateCoupon(Integer marketer_id, Integer coupon_id) {
        ...
        Coupons coupons = couponsRepository.findCouponsById(coupon_id);
        if (coupons.getMarketer().getId() != marketer_id) throw new ApiException("the coupon not belong to you");
        if (coupons.getStatus().equalsIgnoreCase("active")) throw new ApiException("the coupon is already active");
    ...
    public void marketerDeactivateCoupon(Integer marketer_id, Integer coupon_id) {
        ...
        Coupons coupons = couponsRepository.findCouponsById(coupon_id);
        if (coupons.getMarketer().getId() != marketer_id) throw new ApiException("the coupon not belong to you");
        if (coupons.getStatus().equalsIgnoreCase("deactive")) throw new ApiException("the coupon is already deactivate");
    ...
    public void applyCouponOnOrder(Integer shopper_id,Integer order_id, String code) {
        ...
        if (orders == null) throw new ApiException("the Order not exist");
        Shopper shopper=shopperRepository.findShopperById(shopper_id);
        if (shopper == null) throw new ApiException("the shopper not exist");
        if (orders.getShopper().getId()!=shopper_id) throw new ApiException("this Order not belong to you");
        if(orders.isAppliedCoupon()) throw new ApiException("you already applied coupon you can't applied another one");
